...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 overflow-x-hidden selection:bg-pink-100 font-['Montserrat']">
      
      {/* 1. HERO - LILAC & PINK DARK SECTION */}
      <Section className="bg-gradient-to-br from-[#4c1d95] via-[#701a75] to-[#831843] text-white pt-24 pb-20 md:pt-32 md:pb-32 relative overflow-hidden">
        {/* Abstract background elements */}
        <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-pink-500/20 to-transparent pointer-events-none"></div>
        <div className="absolute -top-24 -left-24 w-96 h-96 bg-purple-400/20 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 right-0 w-64 h-64 bg-fuchsia-500/10 rounded-full blur-3xl"></div>
        
        <div className="relative z-10 flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          <div className="flex-1 text-left animate-fadeIn">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/10 text-pink-200 text-[10px] md:text-xs font-bold rounded-full uppercase tracking-widest mb-6 border border-white/20 backdrop-blur-sm">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold leading-[1.1] mb-6 tracking-tight">
              MINI-HISTÓRIAS <span className="text-pink-300">SEM FINAL</span>
            </h1>
            <p className="text-lg md:text-2xl text-purple-100 font-medium leading-relaxed mb-8 max-w-2xl">
              Produção oral espontânea na Educação Infantil através de narrativas visuais que despertam a imaginação.
            </p>
            
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 mb-8">
              <div className="bg-white/10 border border-white/20 backdrop-blur-md p-4 rounded-2xl">
                <span className="text-purple-200 line-through text-sm block">De R$ 47,00</span>
                <span className="text-3xl font-black text-white">R$ 10,00</span>
              </div>
              <Button 
                text="QUERO O ACESSO IMEDIATO" 
                onClick={scrollToCheckout} 
                className="shadow-[0_0_30px_rgba(244,114,182,0.4)] !bg-pink-500 hover:!bg-pink-600 !py-6"
              />
            </div>
            
            <div className="flex items-center gap-4 text-xs text-purple-200 font-medium">
              <span className="flex items-center gap-1"><ShieldCheck size={14} className="text-pink-400"/> Compra Segura</span>
              <span className="flex items-center gap-1"><Download size={14} className="text-pink-400"/> Download Imediato</span>
              <span className="flex items-center gap-1"><Clock size={14} className="text-pink-400"/> Acesso Vitalício</span>
            </div>
          </div>
          
          <div className="flex-1 w-full max-w-xl lg:max-w-none animate-slideInRight">
            <div className="relative">
              <div className="absolute -inset-1 bg-gradient-to-r from-pink-400 to-purple-400 rounded-3xl blur opacity-30 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"></div>
              <div className="relative bg-white/5 backdrop-blur-sm rounded-2xl overflow-hidden shadow-2xl border border-white/20">
                <img 
      ...
      <Section className="bg-white">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-block p-3 bg-pink-50 text-pink-600 rounded-2xl mb-4">
              <BookOpen size={32} />
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-stretch">
            ...
            <div className="bg-pink-500 p-8 rounded-3xl text-white flex flex-col justify-center text-center">
      ...
      <Section className="bg-slate-50">
        <div className="text-center mb-16">
          <div className="inline-block p-3 bg-purple-50 text-purple-600 rounded-2xl mb-4">
            <Target size={32} />
          </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <div key={idx} className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 hover:border-pink-500 transition-all group">
              <div className="w-12 h-12 bg-slate-100 rounded-xl flex items-center justify-center text-slate-500 group-hover:bg-pink-500 group-hover:text-white transition-colors mb-6">
                {item.icon}
              </div>
      ...
      <Section className="bg-white">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="flex-1 order-1 lg:order-2">
            ...
            <div className="mt-10 p-6 bg-slate-50 rounded-2xl border-l-4 border-pink-500">
      ...
      <Section className="bg-[#2e1065] text-white">
        ...
        <div className="mt-16 text-center">
          <p className="text-pink-300 text-xl font-bold mb-8">São 15 histórias completas esperando por você.</p>
          <Button text="EU QUERO ESSAS HISTÓRIAS" onClick={scrollToCheckout} className="!py-5 !px-12 !bg-pink-500 hover:!bg-pink-600" />
        </div>
      </Section>
      ...
      <Section className="bg-white">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <div key={idx} className="p-10 bg-slate-50 rounded-[2rem] border-2 border-transparent hover:border-pink-500 hover:bg-white transition-all text-center group">
              <div className="text-pink-500 mb-6 flex justify-center scale-125">{item.icon}</div>
      ...
      <Section className="bg-slate-50">
        <div className="grid md:grid-cols-2 gap-12">
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={i} className="flex items-start gap-4 text-slate-600">
                  <Check className="text-pink-500 mt-1 flex-shrink-0" size={20} />
          ...
          <div className="bg-white p-12 rounded-[3rem] shadow-sm border border-slate-200">
            <div className="inline-block p-3 bg-pink-50 text-pink-600 rounded-2xl mb-6">
              <Printer size={32} />
            </div>
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={i} className="flex items-start gap-4 text-slate-600">
                  <ArrowRight className="text-purple-500 mt-1 flex-shrink-0" size={20} />
                  <span className="font-medium">{text}</span>
                </li>
              ))}
            </ul>
      ...
      <Section className="bg-[#4c1d95] text-white">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-block p-3 bg-pink-500/20 text-pink-400 rounded-2xl mb-6">
            <Sparkles size={32} />
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-8 text-left">
            {[
              ...
              <div key={i} className="flex items-center gap-5 bg-white/5 p-6 rounded-2xl border border-white/10">
                <div className="w-10 h-10 flex-shrink-0 bg-pink-500 text-white rounded-full flex items-center justify-center font-black">
                  {i + 1}
                </div>
                <p className="text-lg font-medium text-purple-100">{reason}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <footer className="py-24 bg-white border-t border-slate-100 text-center px-6 relative">
        <div className="max-w-3xl mx-auto space-y-10">
          ...
          <div className="p-10 bg-slate-50 rounded-[3rem] border-2 border-pink-100 relative overflow-hidden inline-block w-full">
            <div className="absolute top-0 right-0 w-24 h-24 bg-pink-500/10 rounded-full -mr-10 -mt-10"></div>
            <span className="text-slate-400 line-through text-lg block mb-2">De R$ 47,00</span>
            <span className="text-5xl md:text-6xl font-black text-pink-600 block mb-4">R$ 10,00</span>
            <span className="inline-block px-4 py-1 bg-pink-100 text-pink-700 rounded-full text-xs font-bold uppercase tracking-widest mb-8">Oferta Exclusiva</span>
            
            <div className="flex flex-col items-center gap-6">
              <Button text="QUERO O MATERIAL AGORA" onClick={scrollToCheckout} className="w-full md:w-auto shadow-2xl !bg-pink-500 hover:!bg-pink-600" />
              <div className="flex flex-wrap justify-center gap-6 opacity-40 grayscale mt-4">
                <img src="https://img.shields.io/badge/Compra-Segura-purple?style=flat-square" alt="Compra segura" />
                <img src="https://img.shields.io/badge/Entrega-Imediata-pink?style=flat-square" alt="Entrega imediata" />
                <img src="https://img.shields.io/badge/Garantia-7%20dias-fuchsia?style=flat-square" alt="Garantia" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className={`fixed bottom-0 left-0 w-full p-4 bg-white/90 backdrop-blur-lg border-t border-slate-200 md:hidden z-50 flex items-center justify-between gap-4 transition-transform duration-300 ${isScrolled ? 'translate-y-0' : 'translate-y-full'}`}>
        <div className="flex flex-col">
          ...
          <span className="text-xl font-black text-pink-600 leading-none">R$ 10</span>
        </div>
        <Button text="QUERO AGORA" onClick={scrollToCheckout} className="!py-3 !px-6 !text-sm flex-grow shadow-lg !bg-pink-500" />
      </div>
